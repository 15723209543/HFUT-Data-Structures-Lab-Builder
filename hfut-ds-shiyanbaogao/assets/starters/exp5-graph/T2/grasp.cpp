...
//*******************************************************************//
bool graph::CreateGrpFromFile(char fileName[], Graph &G) {
...
//*******************************************************************//
int graph::CreateGrpFromFile1(char fileName[], Graph &G) {
	FILE* pFile;     //定义顺序表的文件指针
	char str[1000];  //存放读出一行文本的字符串
	char strTemp[10]; //判断是否注释行
	char* ss;
...
//*******************************************************************//
int graph::CreateGraphFromFile(char fileName[], Graph &G) {
	FILE* pFile;			//定义顺序表的文件指针
	char str[1000];			//存放读出一行文本的字符串
	char strTemp[10];		//判断是否注释行
...
//销毁图
void graph::DestroyGraph(Graph &G) {
	EdgeNode *p,*u;
	int vID;
